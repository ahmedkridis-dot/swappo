...
(function () {
  ...
  function injectStyles() {
    ...
    css += '.mega-menu-item--special .mega-menu-item__link{color:#fff;font-weight:700;background:linear-gradient(135deg,#EC4899,#F472B6);border-radius:999px;padding:8px 18px;margin:4px 6px;font-size:12px;letter-spacing:0.02em;box-shadow:0 2px 10px rgba(236,72,153,0.25);animation:giftPulse 3s ease-in-out infinite;}';
    css += '.mega-menu-item--special .mega-menu-item__link:hover{transform:scale(1.06);box-shadow:0 4px 16px rgba(236,72,153,0.4);}';
    css += '.mega-menu-item--special .mega-menu-caret{color:rgba(255,255,255,0.7);}';
    css += '@keyframes giftPulse{0%,100%{box-shadow:0 2px 10px rgba(236,72,153,0.25);}50%{box-shadow:0 4px 20px rgba(236,72,153,0.45);}}';
